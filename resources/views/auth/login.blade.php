    ...
    <div>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div>
                ...
                <x-input-text class="mt-1 block w-full" id="email" name="email" type="email" :value="old('email')"
            ...
            <div class="mt-4">
                ...
                <x-input-text class="mt-1 block w-full" id="password" name="password" type="password" required
